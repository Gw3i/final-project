import AutoInvestPresetForm from '@/components/AutoInvestPresetForm';
...
const page: FC<pageProps> = ({}) => {
  return (
    <section className="grid max-w-xl mx-auto mt-8">
      <h2 className="text-headline-small mb-4">Auto-Invest (Dollar-Cost Average(DCA))</h2>
